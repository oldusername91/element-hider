...
function addKeyUpEventListenerToPage()
{
...
function addHighlight(tohighlight)
{
    ...
    var mdded = MD5(tohighlight.outerHTML);
    if (tohighlight.tagName.toLowerCase() === 'img') {
        window.sessionStorage.setItem(mdded, tohighlight.style.opacity);
        tohighlight.style.opacity = 0.6;
    }
    else {
        window.sessionStorage.setItem(mdded, tohighlight.style.backgroundColor);
        tohighlight.style.backgroundColor = "rgba(0,0,255,.1)";
    }
    tohighlight.classList.add('its_been_highlighted');
    tohighlight.setAttribute('__mdsum', mdded);
}
...
function removeHighlight()
{
    ...
    if (thehighlighted.tagName.toLowerCase() === 'img') {
        thehighlighted.style.opacity = window.sessionStorage.getItem(thehighlighted.getAttribute('__mdsum'));
    }
    else {
        thehighlighted.style.backgroundColor = window.sessionStorage.getItem(thehighlighted.getAttribute('__mdsum'));
    }
    thehighlighted.classList.remove('its_been_highlighted');
    thehighlighted.removeAttribute('__mdsum');
}
